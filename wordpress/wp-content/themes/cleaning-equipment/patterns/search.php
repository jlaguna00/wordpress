 ...
 * Search Section
 * 
 * slug: cleaning-equipment/search
 * title: Search
 * categories: cleaning-equipment
 */

return array(
    'title'      =>__( 'Search', 'cleaning-equipment' ),
...
<!-- wp:column {"width":"30%"} -->
<div class="wp-block-column" style="flex-basis:30%"><!-- wp:template-part {"slug":"sidebar","theme":"cleaning-equipment","tagName":"div"} /--></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group -->',
);