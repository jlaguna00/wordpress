 ...
 * 404 Section
 * 
 * slug: cleaning-equipment/404-page
 * title: 404 Page
 * categories: cleaning-equipment
 */

return array(
    'title'      =>__( '404 Page', 'cleaning-equipment' ),
...
<p class="has-text-align-center has-content-heading-font-size"><strong>'. esc_html('Unfortunately we can’t find that page.','cleaning-equipment') .'</strong></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center">'. esc_html('The page you are looking for doesnt exist or has been moved. Try another url or go to the site homepage.','cleaning-equipment') .'</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->',
);